                ...
                <table role="presentation" width="480" cellspacing="0" cellpadding="0" style="background-color: #18181b; border-radius: 16px; border: 1px solid #27272a; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 40px 40px 24px; text-align: center;">
                            ...
                            <p style="color: #a1a1aa; font-size: 14px; margin: 0; line-height: 1.6;">
                                Use the following verification code to reset your password. This code will expire in 5 minutes.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 8px 40px 32px; text-align: center;">
                            <div style="background-color: #27272a; border-radius: 12px; padding: 16px 24px; font-size: 32px; font-weight: 700; letter-spacing: 6px; color: #10b981; text-align: center; font-family: monospace;">
                                ${otp}
                            </div>
                        </td>
                    </tr>
